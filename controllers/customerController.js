...
exports.signup = async (req, res) => {
    const { name, email, phone, password, confirmPassword, address, profile_picture } = req.body;
...
exports.verifyOtp = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ error: 'An error occurred while verifying OTP.' + err });
    }
};
